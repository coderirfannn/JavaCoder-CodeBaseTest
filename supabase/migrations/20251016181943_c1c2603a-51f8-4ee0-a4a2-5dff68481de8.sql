-- Create exam status enum if not exists
DO $$ BEGIN
...
DROP POLICY IF EXISTS "Students can view questions during active exams" ON public.questions;
...
-- Drop existing triggers if exist and create new ones
